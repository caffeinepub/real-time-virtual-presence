 ...
 * Chrome on Windows can report 'denied' even when the user has granted access.
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[300px] gap-6 p-8 max-w-md mx-auto text-center">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground text-sm">
          AR Room Presence needs your camera to overlay your partner's video in your physical space.
        </p>
      </div>
